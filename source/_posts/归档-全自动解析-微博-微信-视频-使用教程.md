...
categories: 笔记
cover: https://cdn.read.html5.qq.com/image?src=circle&q=0&r=0&imgflag=0&cdn_cache=1800&w=0&h=0&imageUrl=https://learnonly-7.oss-cn-qingdao.aliyuncs.com/2022-3-2/1.png
---
...
<div id='d1'>
<video id="p1" width="100%" height="100%" controls=""  data-poster="https://cdn.read.html5.qq.com/image?src=circle&q=0&r=0&imgflag=0&cdn_cache=1800&w=0&h=0&imageUrl=https://learnonly-7.oss-cn-qingdao.aliyuncs.com/2022-3-2/1.png">
...
<div id='d2'>
<video id="p2" width="100%" height="100%" controls=""  data-poster="https://cdn.read.html5.qq.com/image?src=circle&q=0&r=0&imgflag=0&cdn_cache=1800&w=0&h=0&imageUrl=https://learnonly-7.oss-cn-qingdao.aliyuncs.com/2022-3-2/1.png">
  <source src="http://api.icodeq.com/api/wechat_video_public?wxv_2281672366986412045" type="video/mp4" />
</video>
</div>

<div id='d3'>
<video id="p3" width="100%" height="100%" controls=""  data-poster="https://cdn.read.html5.qq.com/image?src=circle&q=0&r=0&imgflag=0&cdn_cache=1800&w=0&h=0&imageUrl=https://learnonly-7.oss-cn-qingdao.aliyuncs.com/2022-3-2/1.png">
...
![2](https://cdn.read.html5.qq.com/image?src=circle&q=0&r=0&imgflag=0&cdn_cache=1800&w=0&h=0&imageUrl=https://learnonly-7.oss-cn-qingdao.aliyuncs.com/2022-3-2/2.png)
...
<div id='d4'>
<video id="p4" width="100%" height="100%" controls=""  data-poster="https://cdn.read.html5.qq.com/image?src=circle&q=0&r=0&imgflag=0&cdn_cache=1800&w=0&h=0&imageUrl=https://learnonly-7.oss-cn-qingdao.aliyuncs.com/2022-3-2/1.png">
  <source src="https://api.icodeq.com/api/weibo_307_video?uid=3908615569&cursor=4696609415234742&hd=2" type="video/mp4" />
</video>
</div>

<div id='d5'>
<video id="p5" width="100%" height="100%" controls=""  data-poster="https://cdn.read.html5.qq.com/image?src=circle&q=0&r=0&imgflag=0&cdn_cache=1800&w=0&h=0&imageUrl=https://learnonly-7.oss-cn-qingdao.aliyuncs.com/2022-3-2/1.png">
  <source src="https://api.icodeq.com/api/weibo_307_video?uid=1239246050&cursor=4720854242429953&hd=0" type="video/mp4" />
</video>
</div>

<div id='d6'>
<video id="p6" width="100%" height="100%" controls=""  data-poster="https://cdn.read.html5.qq.com/image?src=circle&q=0&r=0&imgflag=0&cdn_cache=1800&w=0&h=0&imageUrl=https://learnonly-7.oss-cn-qingdao.aliyuncs.com/2022-3-2/1.png">
...
![3](https://cdn.read.html5.qq.com/image?src=circle&q=0&r=0&imgflag=0&cdn_cache=1800&w=0&h=0&imageUrl=https://learnonly-7.oss-cn-qingdao.aliyuncs.com/2022-3-2/3.png)

### 网易MV（全自动逆向缓存版）[新增]

> [此 `API` 开源地址](https://github.com/zkeq/icodeq-api/tree/main/api/get_163_mv_vercel#163mv_fast_apizip)

示例视频（最高清）：

<div id='_163mv_div'>
<video id="_163mv_video" width="100%" height="100%" controls=""  data-poster="https://cdn.read.html5.qq.com/image?src=circle&q=0&r=0&imgflag=0&cdn_cache=1800&w=0&h=0&imageUrl=https://learnonly-7.oss-cn-qingdao.aliyuncs.com/2022-3-2/1.png">
...
![10](https://cdn.read.html5.qq.com/image?src=circle&q=0&r=0&imgflag=0&cdn_cache=1800&w=0&h=0&imageUrl=https://learnonly-7.oss-cn-qingdao.aliyuncs.com/2022-3-2/10.png)
...
<div id='d7'>
<video id="p7" width="100%" height="100%" controls=""  data-poster="https://cdn.read.html5.qq.com/image?src=circle&q=0&r=0&imgflag=0&cdn_cache=1800&w=0&h=0&imageUrl=https://learnonly-7.oss-cn-qingdao.aliyuncs.com/2022-3-2/1.png">
...
![4](https://cdn.read.html5.qq.com/image?src=circle&q=0&r=0&imgflag=0&cdn_cache=1800&w=0&h=0&imageUrl=https://learnonly-7.oss-cn-qingdao.aliyuncs.com/2022-3-2/4.png)
...
<div id='d8'>
<video id="p8" width="100%" height="100%" controls=""  data-poster="https://cdn.read.html5.qq.com/image?src=circle&q=0&r=0&imgflag=0&cdn_cache=1800&w=0&h=0&imageUrl=https://learnonly-7.oss-cn-qingdao.aliyuncs.com/2022-3-2/1.png">
...
![5](https://cdn.read.html5.qq.com/image?src=circle&q=0&r=0&imgflag=0&cdn_cache=1800&w=0&h=0&imageUrl=https://learnonly-7.oss-cn-qingdao.aliyuncs.com/2022-3-2/5.png)
...
<div id='d9'>
<video id="p9" width="100%" height="100%" controls=""  data-poster="https://cdn.read.html5.qq.com/image?src=circle&q=0&r=0&imgflag=0&cdn_cache=1800&w=0&h=0&imageUrl=https://learnonly-7.oss-cn-qingdao.aliyuncs.com/2022-3-2/1.png">
...
<div id='d10'>
<video id="p10" width="100%" height="100%" controls=""  data-poster="https://cdn.read.html5.qq.com/image?src=circle&q=0&r=0&imgflag=0&cdn_cache=1800&w=0&h=0&imageUrl=https://learnonly-7.oss-cn-qingdao.aliyuncs.com/2022-3-2/1.png">
...
![5](https://cdn.read.html5.qq.com/image?src=circle&q=0&r=0&imgflag=0&cdn_cache=1800&w=0&h=0&imageUrl=https://learnonly-7.oss-cn-qingdao.aliyuncs.com/2022-3-2/6.png)
...
const dp1 = new DPlayer({
    ...
    preload:'none',
    video: {
        pic:'https://cdn.read.html5.qq.com/image?src=circle&q=0&r=0&imgflag=0&cdn_cache=1800&w=0&h=0&imageUrl=https://learnonly-7.oss-cn-qingdao.aliyuncs.com/2022-3-2/1.png',
...
const dp2 = new DPlayer({
    ...
    video: {
        pic:'https://cdn.read.html5.qq.com/image?src=circle&q=0&r=0&imgflag=0&cdn_cache=1800&w=0&h=0&imageUrl=https://learnonly-7.oss-cn-qingdao.aliyuncs.com/2022-3-2/1.png',
        url: 'http://api.icodeq.com/api/wechat_video_public?wxv_2281672366986412045'
    },
});
const dp3 = new DPlayer({
    ...
    video: {
        pic:'https://cdn.read.html5.qq.com/image?src=circle&q=0&r=0&imgflag=0&cdn_cache=1800&w=0&h=0&imageUrl=https://learnonly-7.oss-cn-qingdao.aliyuncs.com/2022-3-2/1.png',
        url: 'http://api.icodeq.com/api/wechat_video_public?wxv_2281669760981450761'
    },
});
