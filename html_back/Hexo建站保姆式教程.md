...
2. 点击下图所示位置
   ...
   <img src="https://img.onmicrosoft.cn/2021-12-13/1.png" alt="1" style="zoom:50%;" />
...
2. 滑到底部点击最后一个(可能因为时间原因,看到本文时已经出现新版本,请选择最新版本)
   ...
   <img src="https://img.onmicrosoft.cn/2021-12-13/2.png" alt="2" style="zoom:80%;" />
...
2.  `% %` 其实是父子集的关系 例如 右边的其实是索引到左边那个变量
   ...
   ![5](https://img.onmicrosoft.cn/2021-12-13/5.png)
...
> 网易云的音乐引用直链(付费的歌曲不可用) http://music.163.com/song/media/outer/url?id=这里填歌曲id.mp3
>
> 音乐引用html代码:
>
> ```html
