...
2.  `% %` 其实是父子集的关系 例如 右边的其实是索引到左边那个变量
   ...
   ![5](https://cdn.read.html5.qq.com/image?src=circle&q=0&r=0&imgflag=0&cdn_cache=1800&w=0&h=0&imageUrl=https://learnonly-7.oss-cn-qingdao.aliyuncs.com/2021-12-13/5.png)
