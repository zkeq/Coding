...
srcdoc="<head><base target='_blank'/></head><body><script src='https://gist.onmicrosoft.cn/zkeq/${id}.js'></script><style>.gist-meta a:nth-child(2) {overflow:hidden;text-overflow: ellipsis;display: inline-block;max-width: 80px;} html {overflow: hidden;text-overflow: ellipsis;display: inline-block;}</style></body>">
</iframe>
